...
User.destroy_all
  ...
  # Wizards
  angela = User.create!(username: "loves_capy", age: 11, political_affiliation: "Gryffindor", email: "chosenone@aa.io", password: "password")
  ...
  lina = User.create!(username: "lean_on_me", age: 11, political_affiliation: "Ravenclaw", email: "leans@aa.io", password: "password")
  alissa = User.create!(username: "cow_luva", age: 11, political_affiliation: "Ravenclaw" , email: "cows@aa.io", password: "password")
  julia = User.create!(username: "owes_us_airpods", age: 11, political_affiliation: "Slytherin" , email: "j@aa.io", password: "password")
  ryan = User.create!(username: "will_climb_rocks", age: 11, political_affiliation: "Gryffindor" , email: "boulderz@aa.io", password: "password")
  charlos = User.create!(username: "how_do_we_get_there", age: 11, political_affiliation: "Gryffindor", email: "stuff@aa.io", password: "password")
  erik = User.create!(username: "charlos_gets_buckets", age: 11, political_affiliation: "Hufflepuff", email: "ballin@aa.io", password: "password")
  elliot = User.create!(username: "all_knowing_elliot", age: 11, political_affiliation: "Ravenclaw", email: "those_are_teef@aa.io", password: "password")
